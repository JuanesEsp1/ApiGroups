        ...
        <div className={`w-full h-20 ${data.colorBack}`}>
            <div className="w-full h-full flex justify-between items-center">
                <div className="flex px-6 ">
                    ...
                    />
                    <div className={`px-5 ${lilita.className} text-slate-50 font-semibold hidden sm:block lg:flex lg:items-center text-5xl`}>
                        {data.headerName}
                    </div>
                </div>
            <div className=" px-6">
               ...
               <Sheet>
                <SheetTrigger><IoMenu className=" text-5xl text-white " /></SheetTrigger>
                <SheetContent>
                    crear componente del menu aqui 
                </SheetContent>
                </Sheet>
            </div>
