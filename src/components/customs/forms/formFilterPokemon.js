   ...
   return (
      <div className="w-full h-full flex flex-col relative ">
         <div className="w-full">
            <div
               className={`${lilita.className} text-[30px] flex justify-center items-center pt-4`}
            >
               FILTER YOUR POKEMON
            </div>
         </div>
         <div className="w-full flex flex-col justify-center items-center py-16 gap-9">
            <form
               ...
               className="w-full flex flex-row justify-center items-center pl-4"
            >
               <input
            ...
            <form
               onSubmit={handleSubmit(onSubmitWeakness)}
               className="w-full flex flex-row justify-center items-center pl-4"
            >
               <input
            ...
            <form
               onSubmit={handleSubmit(onSubmitType)}
               className="w-full flex flex-row justify-center items-center pl-4"
            >
               <input
            ...
            <form onSubmit={handleSubmit(onSubmitReset)}>
               <button
                  type="submit"
                  className="w-[330px] h-[40px] border-[3px] rounded hover:border-slate-950"
               >
                  Reset all
               </button>
            </form>
