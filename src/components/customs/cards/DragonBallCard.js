            ...
            <div className="w-full h-full  rounded-3xl">
               <div className="w-full h-72  rounded-t-3xl flex relative ">
                  ...
                  <div className="w-full absolute bottom-2 p-5 flex justify-center items-center">
                     <Image
                        className="flex max-h-64 min-h-56 min-w-28"
                        height={0}
                        width={100}
                        src={data.image}
                        alt=""
               ...
               <div
                  className={`w-full h-[calc(100%-288px)] p-4 flex justify-center items-center rounded-b-3xl ${colorCard}`}
               >
