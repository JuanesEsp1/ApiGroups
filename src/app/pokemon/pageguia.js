...
const pokemon = () => {
   ...
   const [listData,setArrayData,pagination,page,totalList] = usePaginationDate();
               ...
               <div className="grid grid-cols-1 md:grid-cols-1 md:gap-x-10 xl:grid-cols-1 2xl:grid-cols-1 gap-5  ">
                  ...
                  <div className="w-full grid grid-cols-2 gap-3">
                     ...
                     <div onClick={() => {
                        ...
                        filterId(1)
                        pagination(1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-sky-300 rounded cursor-pointer  ">Filter  id</div>
                     <div onClick={()=>{
                        console.log('filtrando por name')
                        filterName('pikachu')
                        pagination(1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-sky-300 rounded cursor-pointer  ">Filter  name</div>
                     <div onClick={()=>{
                        console.log('filtrando por type')
                        filterType('fire')
                        pagination(1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-sky-300 rounded cursor-pointer  ">Filter  type</div>
                     <div onClick={()=>{
                        console.log('mostrando todos')
                        showAll()
                        pagination(1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-sky-300 rounded cursor-pointer  ">show  all</div>
                     <div onClick={()=>{
                        pagination(page-1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-emerald-300 rounded cursor-pointer mt-5  ">before</div>
                     <div onClick={()=>{
                        pagination(page+1)
                     }} className="w-[100px] h-[30px] flex justify-center items-center bg-emerald-300 rounded cursor-pointer mt-5  ">after</div>
